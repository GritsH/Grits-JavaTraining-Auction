...
public class DaoInitializer {
    ...
    public void initializeUsers(UserDao userDao) throws DaoException {
        ...
        userDao.add(new User("somename", "375293333333", "somename@gmail.com", "simplePassword", RoleType.USER));
    ...
    public void initializeItems(ItemDao itemDao) throws DaoException {
        ...
        itemDao.add(new Item("guitar", "description of guitar", "name2@mail.com", ItemType.MUSICAL_INSTRUMENT));
        itemDao.add(new Item("painting", "description of painting", "aaaaa@mail.com", ItemType.PAINTING));
        ...
        itemDao.add(new Item("cdsacdsa", "description of cdsacdsa", "somename@gmail.com", ItemType.OTHER));
    }
}
